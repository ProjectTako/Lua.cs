namespace Lua.Binding
{
    static class BindingError
    {
        ...
        public const string TooManyConstructors = "Classes cannot have multiple Lua constructors";
        public const string NotEnoughConstructors = "Classes must have one Lua constructor";
    }
}
